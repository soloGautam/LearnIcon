...
const DEMO_JOBS: JobListing[] = [
  {
    id: "demo-1",
    companyName: "Stripe",
    companyEmail: "hiring@stripe.com",
    title: "ML Engineer — Fraud Detection",
    roleType: "Full-time",
    location: "Remote",
    minXpLevel: 8,
    requiresBuilderBadge: true,
    description: "Join our ML team to build real-time fraud detection models. You'll ship production ML systems used by millions daily.",
    postedAt: new Date(Date.now() - 2 * 86400000).toISOString(),
  },
  {
    id: "demo-2",
    companyName: "Linear",
    companyEmail: "jobs@linear.app",
    title: "AI Product Manager",
    roleType: "Full-time",
    location: "Hybrid · San Francisco",
    minXpLevel: 5,
    requiresBuilderBadge: false,
    description: "Shape the future of AI-powered project management. You'll own the AI roadmap and work closely with engineering.",
    postedAt: new Date(Date.now() - 5 * 86400000).toISOString(),
  },
  {
    id: "demo-3",
    companyName: "Vercel",
    companyEmail: "careers@vercel.com",
    title: "Applied AI Engineer",
    roleType: "Contract",
    location: "Remote",
    minXpLevel: 6,
    requiresBuilderBadge: true,
    description: "Build AI-powered developer tooling for the next generation of frontend engineers.",
