...
function Dashboard() {
  ...
  const placements = [
    { name: "Aanya R.", role: "ML Engineer", company: "Stripe", tone: "purple" },
    { name: "Karthik S.", role: "AI PM", company: "Linear", tone: "blue" },
    { name: "Mia T.", role: "Applied AI", company: "OpenAI", tone: "amber" },
  ];
  const updates = [
    { title: "Code Studio v2.4", body: "Live error linting + AI fix suggestions.", tag: "New" },
    { title: "Weekly leaderboard", body: "Reset Mondays at 9am IST.", tag: "Update" },
    { title: "Persona packs", body: "Pro & Titan get 6 new AI personas.", tag: "Pro" },
  ];
  const qualities = [
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_320px]">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-3 xl:grid-cols-5">
            ...
            <StatCard tone="pink" icon={<Award className="size-4" />} label="Achievements" value={String(user.achievements.length)} sub="Recent unlocks" />
          </div>
